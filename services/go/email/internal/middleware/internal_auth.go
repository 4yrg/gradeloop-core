...
// InternalAuth validates the X-Internal-Token header for internal service-to-service communication.
// This middleware ensures that only requests with a valid internal token can access protected endpoints.
