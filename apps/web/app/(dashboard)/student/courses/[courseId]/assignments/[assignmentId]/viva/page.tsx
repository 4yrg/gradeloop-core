        ...
        <div className="flex flex-col gap-8 pb-20 max-w-6xl mx-auto w-full px-4">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-1">
                        <h1 className="text-4xl font-bold tracking-tight">Viva Evaluation</h1>
                        <p className="text-muted-foreground">Oral examination for Balanced Binary Search Trees.</p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <CardContent className="space-y-4">
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li className="flex items-start gap-2">
                                    ...
                                    Explain your implementation of the AVL tree rotations.
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                                    Justify your choice of data structures for the level-order traversal.
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                                    Answer any follow-up questions from the instructor.
                                </li>
                            </ul>
                        </CardContent>
                    </Card>
                ...
                <div className="space-y-6">
                        ...
                        <CardContent>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between text-xs">
                                    <span className="text-muted-foreground">Viva Scheduled</span>
                                    <span className="font-bold font-mono">10:00 AM - 10:15 AM</span>
                                </div>
                                <div className="flex justify-between text-xs">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Pre-Viva Checklist</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs">Quiet environment</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="h-4 w-4 rounded border border-primary flex items-center justify-center bg-primary/10">
                                    <CheckCircle2 className="h-3 w-3 text-primary" />
                                </div>
                                <span className="text-xs">Functional Camera/Mic</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="h-4 w-4 rounded border border-primary flex items-center justify-center bg-primary/10">
                                    <CheckCircle2 className="h-3 w-3 text-primary" />
                                </div>
                                <span className="text-xs">Strong Internet (3mbps+)</span>
                            </div>
                        </CardContent>
                    </Card>
                </div>
