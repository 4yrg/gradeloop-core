...
import { Settings, FileCode, Save, FolderOpen, Play, Bug } from "lucide-react"

export function MenuBar() {
    const { setActiveActivity, togglePanel, toggleAuxiliaryBar } = useIdeStore()

    return (
        <div className="h-8 border-b flex items-center px-2 bg-background select-none">
