                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive ? "bg-primary/5 text-primary ring-1 ring-primary/10" : "hover:bg-muted text-muted-foreground"
                                )}
                            >
                                ...
                                {isCompleted ? (
                                    ...
                                    <Circle className="h-5 w-5 opacity-40 group-hover:opacity-100 transition-opacity shrink-0" />
                                )}
