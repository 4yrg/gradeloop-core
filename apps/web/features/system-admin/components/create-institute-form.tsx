...
export function CreateInstituteForm() {
    const { createInstituteStep, setCreateInstituteStep, setCreateModalOpen } = useSystemAdminStore()
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-2 gap-y-4 text-sm">
                                <div>
                                    ...
                                    <div className="text-muted-foreground">{form.getValues("name")}</div>
                                </div>
                                <div>
                                    <div className="font-semibold">Institute Code</div>
                                    <div className="text-muted-foreground">{form.getValues("code")}</div>
                                </div>
                                <div>
                                    <div className="font-semibold">Domain</div>
                                    <div className="text-muted-foreground">{form.getValues("domain")}</div>
                                </div>
                                <div>
